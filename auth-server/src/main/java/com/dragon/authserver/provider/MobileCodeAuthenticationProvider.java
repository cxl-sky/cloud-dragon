...
public class MobileCodeAuthenticationProvider implements AuthenticationProvider, MessageSourceAware {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        UserDetails user;
        try {
            DragonUserDetailServiceImpl dragonUserDetailService = (DragonUserDetailServiceImpl)userDetailsService;
            user = dragonUserDetailService.loadUserByMobile(mobile);
