...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/generator");  //生成路径(一般都是生成在此项目的src/main/java下面)
        gc.setAuthor("chenxiaolong"); //设置作者
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/user-center?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8");
